...
Wave R slice 75 (`slice/75-operator-visible-pipeline`) — see
[docs/STATUS.md](docs/STATUS.md). Not ✅ PASSED until Gate 4 + merge.
...
| Review | Heatmap, drawers, pathway strips, Escalated / SIE-only filters; Run→Report chrome on **Workflow** tab (slice 75: GWT-75.1–75.11 IMPLEMENTED unit; Gate 4 pending) | Dashboard (Live or Mock) | [reading-router-results](docs/user-guide/reading-router-results.md) · [screenshots](docs/screenshots/README.md) |
