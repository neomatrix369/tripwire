const items = [
  ...
  { id:'i3', type:'skill', name:'vuln-prompt-injection-notes', identifier:'vuln-prompt-injection-notes', status:'red', risk:0.04, quality:61, locus:'local', avail:'source_on_disk', lastScan:'2026-07-31T18:44:00Z', findings:[
    ...
    {severity:'amber', category:'instruction_clarity', file_path:'SKILL.md', location:'3-6', scanner:'Tessl: Review (Quality)', message:'Skill instructions omit an explicit deny-list for override phrasing.'}
  ], scanners:[
    {source:'Cisco Skill Scanner: static/bytecode/pipeline', status:'completed', checks_run:34, output:{raw_summary:'34 checks passed — no findings'}},
    ...
    {source:'Tessl: Lint', status:'completed', checks_run:12, output:{raw_summary:'12 checks — 0 findings'}},
    {source:'Tessl: Review (Quality)', status:'completed', checks_run:1, tessl_run_id:'rev_abc123', output:{quality_score:61}},
    {source:'Tessl: Review (Security)', status:'completed', checks_run:1, tessl_run_id:'sec_rev_def456', upstream_run_ids:{review_quality:'rev_abc123'}, output:{raw_summary:'review completed'}}
