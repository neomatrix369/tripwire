...
| **GitHub Actions** | CI · Nightly (A Light T4 daily) · Supply chain (B weekly) · Mutation (C 1st+15th) · complexity | Contributors | Repo secrets as needed — not operator Live; [ADR-0013](./adr/0013-ship-path-quality-gates.md) |
