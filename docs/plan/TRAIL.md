...
| # | File | Name | MoSCoW | Status | Depends on | Issue | Read time |
|---|------|------|--------|--------|------------|-------|-----------|
| 40 | [slice-40-scan-type-filter](slices/08-H-frontline-agent-hooks/slice-40-scan-complexity-decomposition.md) | `tripwire scan --type <skill\|mcp>` filter | Must | 📋 | — | — | ~3 min |
