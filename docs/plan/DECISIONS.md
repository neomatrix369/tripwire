...
| 2026-08-15 | slice-29 | AT design | Seven GWTs after acceptance critique (observable Then clauses + not-found skip). Coverage ≥95% on `guard/scan.py`. |
| 2026-08-15 | slice-29 | acceptance-review NITs | Deferred vs full nWave DISTILL: Mandate-14 `@contract-shape` tags and 40% error-path AT ratio — Wave H follows slice 27/28 pattern (≤7 binary GWTs, skill file lands in GREEN). Logged, not blocking. |
