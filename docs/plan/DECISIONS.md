...
| 2026-08-11 | packaging | ADR-0001 Proposed | Monk Kit as the hosted Live deploy/packaging path (Supabase entity + in-cluster bootstrap + dashboard; Modal stays SaaS). Formal record: `docs/adr/0001-monk-deployment-and-packaging.md`. Implementation not started on this branch. |
