...
| 18 | [`18-R-…`](slices/18-R-approved-repo-workflow/) | **R — Approved-repo security workflow** | **65**→**69** Must · **70**–**71** Should · **72** Could | **65–66** ✅ · **67**–**68** ✅ · **71** 🔀 · 69–70 📋 · **72** ✅ |
...
- Wave **R** (slices **65–72**) approved-repo security workflow: **65–66** ✅ · **67**–**68** ✅ (#151/#152) · **71** 🔀 on `slice/71-expert-export-report` · **69**–**70** 📋 · **72** ✅ landed `main` (#150). UI 1A.
