...
|------:|-----:|---|-------|--------|--------|
| 0 (active) | R | **65** | **Language/ecosystem coverage ledger** | Must | 🚧 IN PROGRESS on `slice/65-lang-ecosystem-coverage-ledger` · Cargo honesty absorbed (#147) |
...
| # | Slice | MoSCoW | Status | Started | Completed | Est. time |
|---|-------|--------|--------|---------|-----------|-----------|
| 65 | [slice-65-lang-ecosystem-coverage-ledger](slices/18-R-approved-repo-workflow/slice-65-lang-ecosystem-coverage-ledger.md) | Must | 🚧 IN PROGRESS | — | — | ~50 min [Walking Skeleton] |
