...
| 5 | [slice-5-gate-evidence-docs-sync](slice-5-gate-evidence-docs-sync.md) | Should | 🔀 | 2026-08-02 | — | ~25 min |
...
| 2026-08-02 | slice/5-gate-evidence-docs-sync | slice-workflow | 5 | 🔀 ON BRANCH | build-day 3-lite sync; slice 4 waived |
