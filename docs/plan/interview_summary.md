...
- Product SoT: `private source`; demo lens: `01_demo_video/00-tripwire-demo-script.md`; gates: `build-day-decisions.md` §8.
...
- `private source/` gitignored — public plan artifacts go under `docs/plan/`.
