...
| Git repo skill+MCP fan-out (DECIDED plan — not shipped) | [slice 62](./plan/slices/16-P-git-repo-scan/slice-62-git-repo-discover-fanout.md) · Wave P in [STATUS](./STATUS.md) |
